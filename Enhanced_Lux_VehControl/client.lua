		...
		if newstate ~= state_airmanu[veh] then
			...
			if newstate == 1 then
				...
				if useFiretruckSiren(veh) then
					...
					PlaySoundFromEntity(snd_airmanu[veh], "SIREN_FOXTROT", veh, "DLC_WMSIRENS_SOUNDSET", 0, 0)
				end
			...
			elseif newstate == 3 then
				snd_airmanu[veh] = GetSoundId()
				PlaySoundFromEntity(snd_airmanu[veh], "VEHICLES_BRAVO", veh, "DLC_WMSIRENS_SOUNDSET", 0, 0)
